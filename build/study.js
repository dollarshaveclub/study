  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default.a(Study, [{
      ...
      this.providedTests.forEach(function (test) {
...

        {
          ...
          if (bucket && test.buckets[bucket]) {
            persistedUserAssignments[test.name] = userAssignments[test.name] = previousAssignments[test.name];
            return;
          }
        }
        ...
        // randomly assign
        {
          ...
          persistedUserAssignments[test.name] = userAssignments[test.name] = __WEBPACK_IMPORTED_MODULE_5__utils__["a" /* chooseWeightedItem */](names, weights);
        }
      });
    ...
    value: function assign(testName, bucketName) {
      ...
      if (bucketName === null || !test) {
        ...
        this.userAssignments[testName] = this.persistedUserAssignments[testName] = bucketName || __WEBPACK_IMPORTED_MODULE_5__utils__["b" /* getDefaultBucket */](test.buckets);
      }
