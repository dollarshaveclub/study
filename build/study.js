...
/* harmony default export */ __webpack_exports__["a"] = (function () {
  var store = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_create___default()(null);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass__ = __webpack_require__(29);
...
var Study = function () {
  function Study() {
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck___default()(this, Study);

    __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_assign___default()(this, {
      storageKey: 'ab-tests',
      root: typeof document !== 'undefined' ? document.body : null
    }, options);

    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__utils__["a" /* validateStore */])(this.store);
  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Study, [{
    key: 'define',
    value: function define(tests) {
      ...
      normalizedData.forEach(function (test) {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(test.buckets)) throw new Error('Tests must have buckets');
    ...
    value: function applyClasses() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(userAssignments).forEach(function (testName) {
    ...
    value: function assignAll() {
      ...
      this.providedTests.forEach(function (test) {
        ...
        {
          var winner = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(test.buckets).filter(function (name) {
        ...
        if (test.active === false) {
          userAssignments[test.name] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__utils__["b" /* getDefaultBucket */])(test.buckets);
          return;
        }

        // randomly assign
        {
          var names = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(test.buckets);
          var weights = [];
          ...
          var _assignment = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__utils__["c" /* chooseWeightedItem */])(names, weights);
    ...
    value: function assign(testName, bucketName) {
      ...
      var assignment = bucketName || __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__utils__["b" /* getDefaultBucket */])(test.buckets);
    ...
    value: function persist() {
      this.store.set(this.storageKey, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(this.persistedUserAssignments));
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__study__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_browser_cookie__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stores_local__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__stores_memory__ = __webpack_require__(20);
...
var stores = {
  browserCookie: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__stores_browser_cookie__["a" /* default */])(),
  local: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__stores_local__["a" /* default */])(),
  memory: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__stores_memory__["a" /* default */])()
};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return chooseWeightedItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getDefaultBucket; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return validateStore; });
...
var getDefaultBucket = function getDefaultBucket(buckets) {
  var defaultBuckets = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(buckets).filter(function (name) {
    var x = buckets[name];
    return x.default || x.winner;
  });
  return defaultBuckets[0] || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(buckets)[0];
};
